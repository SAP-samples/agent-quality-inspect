    ...
    def evaluate(
        ...
        if not progress_scores:
            raise EvaluationError(
                ...
                message="No progress score produced for PPT calculation.",
            )
        ...
        return NumericalScore(
            score=round(ppt_score.score, 4),
            explanations=progress_explanations,
            sub_scores=sub_scores,
        )

    @staticmethod
    def get_ppt_score_from_progress_scores(
        ...
        try:
            ...
            raise EvaluationError(
                internal_code=ErrorCode.PPT_CALCULATION_ERROR.value,
